...
- add a feature for this telegram bot to search / chat / process my messages (option 1: just chat with all recent (personal) messages. option 2: use embeddings to search relevant snippets)
- mongo db support
  - messages collection
