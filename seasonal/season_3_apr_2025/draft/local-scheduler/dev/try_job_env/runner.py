...
job_path = Path("/Users/petrlavrov/work/projects/calmmage/seasonal/season_3_apr_2025/draft/local-scheduler/dev/try_job_env/job.py")
env_file_path = Path("/Users/petrlavrov/work/projects/calmmage/seasonal/season_3_apr_2025/draft/local-scheduler/dev/try_job_env/.env")
...
def run_job(
    ...
    return run(
        [str(task_description.python_executable_path), str(task_description.script_path)],
