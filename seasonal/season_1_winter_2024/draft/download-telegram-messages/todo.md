...
- [x] 
    1. Save telethon user session to somewhere persistently
- [ ] 
    2. add a new botspot component for telethon client
- [x] 
    3. Modify ask_user to handle message cleanup
- [x] 
    4. Add proper session initialization and verification
- [ ] 
...
- [ ] 
    ...
    - [ ] bot info?
    - [ ] ... all the other components that store stuff in deps. Notion client. GPT
      client / token.
